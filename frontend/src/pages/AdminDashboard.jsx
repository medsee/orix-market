      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex gap-1 border-b border-gray-200 mb-4">
          {[
            ...
            { id: 'sms',      label: '📱 SMS' },
            { id: 'live',     label: '⚡ Live' },
            { id: 'coupons',  label: '🎟️ Promokodlar' },
          ].map(t => (
                      ...
                      <tr key={p._id} className="hover:bg-gray-50/50 transition-colors">
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <ProductImage src={p.image} emoji={p.emoji} alt={p.name}
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1">
                            <button onClick={() => setModal(p)} className="p-1.5 text-gray-400 hover:text-brand-green hover:bg-green-50 rounded-lg transition-colors" title="Tahrirlash">
                              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
